...
public static class Data
{
    ...
    public static TrustToGenerate[] TrustsToGenerate { get; } =
    {
        ...
        new("ST MARY'S ACADEMY TRUST", TrustType.SingleAcademyTrust),
        new("ST MARY'S ANGLICAN ACADEMY", TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC HIGH SCHOOL ACADEMY TRUST", TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC PRIMARY SCHOOL", TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC PRIMARY SCHOOL (ACADEMY TRUST), SWINDON",
            TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC PRIMARY SCHOOL (HERRINGTHORPE), A CATHOLIC VOLUNTARY ACADEMY",
            TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC PRIMARY SCHOOL (MALTBY)", TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC PRIMARY SCHOOL, CHURCHDOWN", TrustType.SingleAcademyTrust),
        new("ST MARY'S CATHOLIC PRIMARY SCHOOLS TRUST"),
        new("ST MARY'S CE ACADEMY, CHESHUNT", TrustType.SingleAcademyTrust),
        new("ST MARY'S CHURCH OF ENGLAND ACADEMY TRUST", TrustType.SingleAcademyTrust),
        new("ST MARY'S CHURCH OF ENGLAND ACADEMY, STOTFOLD", TrustType.SingleAcademyTrust),
        new("ST MARY'S CHURCH OF ENGLAND JUNIOR SCHOOL", TrustType.SingleAcademyTrust),
        new("ST MARY'S CHURCH OF ENGLAND PRIMARY ACADEMY, DILWYN", TrustType.SingleAcademyTrust),
        new("ST MARY'S CHURCH OF ENGLAND SCHOOL, NORWOOD GREEN", TrustType.SingleAcademyTrust),
        new("ST MARY'S CHURCH OF ENGLAND VA PRIMARY ACADEMY", TrustType.SingleAcademyTrust),
